  ...
  return (
    <div className="flex flex-col gap-16 ">
      <div className="flex items-center gap-20 md:flex-col">
        <Image src={'/sports-tools.jpg'} alt="sports-tools" width={400} height={400} className="rounded-lg md:w-full"  />
      ...
      <div className="flex items-center gap-20 md:flex-col">
        <Image src={'/top-view-table-full-delicious-food-composition.jpg'} alt="top-view-table-full-delicious-food-composition.jpg" width={400} height={400} className="rounded-lg md:w-full" />
        <section className="flex flex-col gap-3">
      ...
      <div className="flex items-center gap-20 md:flex-col">
        <Image src={'/friends-skiers-having-fun-ski-resort-mountains-winter-skiing-snowboarding.jpg'} alt="friends-skiers-having-fun-ski-resort-mountains-winter-skiing-snowboarding" width={400} height={400} className="rounded-lg md:w-full" />
